...
ALTER TABLE enterprise.reading_materials FORCE ROW LEVEL SECURITY;
...
GRANT SELECT,INSERT,UPDATE,DELETE ON enterprise.reading_materials TO dt_enterprise_app;
ALTER TABLE enterprise.reading_workspaces ENABLE ROW LEVEL SECURITY;
ALTER TABLE enterprise.reading_workspaces FORCE ROW LEVEL SECURITY;
...
GRANT SELECT,INSERT,UPDATE,DELETE ON enterprise.reading_workspaces TO dt_enterprise_app;
ALTER TABLE enterprise.reading_workspace_materials ENABLE ROW LEVEL SECURITY;
ALTER TABLE enterprise.reading_workspace_materials FORCE ROW LEVEL SECURITY;
...
GRANT SELECT,INSERT,UPDATE,DELETE ON enterprise.reading_workspace_materials TO dt_enterprise_app;
ALTER TABLE enterprise.reading_workspace_sessions ENABLE ROW LEVEL SECURITY;
ALTER TABLE enterprise.reading_workspace_sessions FORCE ROW LEVEL SECURITY;
...
GRANT SELECT,INSERT,UPDATE,DELETE ON enterprise.reading_workspace_sessions TO dt_enterprise_app;
ALTER TABLE enterprise.reading_session_links ENABLE ROW LEVEL SECURITY;
ALTER TABLE enterprise.reading_session_links FORCE ROW LEVEL SECURITY;
...
GRANT SELECT,INSERT,UPDATE,DELETE ON enterprise.reading_session_links TO dt_enterprise_app;
